...
class InspirationsControllerTest < ActionController::TestCase
  ...
  test "should create inspiration" do
    assert_difference('Inspiration.count') do
      post :create, inspiration: { likes: @inspiration.likes, page_number: @inspiration.page_number, quote: @inspiration.quote }
    end
  ...
  test "should update inspiration" do
    patch :update, id: @inspiration, inspiration: { likes: @inspiration.likes, page_number: @inspiration.page_number, quote: @inspiration.quote }
    assert_redirected_to inspiration_path(assigns(:inspiration))
  end
